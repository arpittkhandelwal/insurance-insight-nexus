...
- **Deployed AWS Architecture (from infra_stack.py)**:
...
| Fraud Leakage Blocked | INR Crores | Early identification of coordinated fraud rings in anomaly dashboards | Claims Data | YES |
